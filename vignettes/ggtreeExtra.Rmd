...
```{r, fig.align="center", fig.height=7, fig.width=7, dpi=300, warning=FALSE, singlelayer}
...
p3 <- p2 + 
      ...
      geom_fruit(
          ...
          axis.params=list(                
                        add.axis=TRUE,  # add axis text of the layer.
...
p5 <- p4 + 
      ...
      geom_fruit(
          ...
          grid.params=list(
                          add.grid=TRUE # add the grid line of the external bar plot.
                      )
      ) + 
      scale_fill_manual(
          values=c("#F8766D", "#C49A00", "#53B400", "#00C094", "#00B6EB", "#A58AFF", "#FB61D7"),
...
```{r, fig.align="center", fig.width=7, fig.width=7, dpi=300, multilayer}
# To reproduce.
set.seed(1024)
...
If you have questions/issues, please visit [github issue tracker](https://github.com/YuLab-SMU/ggtreeExtra/issues).
